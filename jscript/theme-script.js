...
(function ($) {
	...
	jQuery(".tipsy-n").tipsy({fade: true, gravity: 'n'});
	jQuery(".thumb-tipsy-n").tipsy({fade: true, gravity: 'n', delayIn: 500, delayOut: 0});
	jQuery(".tipsy-e").tipsy({fade: true, gravity: 'e'});
	jQuery(".tipsy-s").tipsy({fade: true, gravity: 's'});
	jQuery(".tipsy-w").tipsy({fade: true, gravity: 'w'});
	jQuery(".tipsy-ne").tipsy({fade: true, gravity: 'ne'});
	jQuery(".tipsy-nw").tipsy({fade: true, gravity: 'nw'});
	jQuery(".tipsy-se").tipsy({fade: true, gravity: 'se'});
	jQuery(".tipsy-sw").tipsy({fade: true, gravity: 'sw'});
